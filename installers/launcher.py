...
def show_menu():
    ...
    console.print("  [#c9c3d9]3[/#c9c3d9]  Relay install (TNC RNode)")
    console.print("  [#c9c3d9]4[/#c9c3d9]  Add an interface")
    console.print("  [#c9c3d9]5[/#c9c3d9]  Exit\n")
    return Prompt.ask("Selection", choices=["1", "2", "3", "4", "5"])
...
def main():
    ...
    if choice == "1":
        ...
        run_script("install_relay.sh")
    elif choice == "4":
        run_script("../utilities/add_interface.sh")
    else:
